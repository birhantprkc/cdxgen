...
export declare const frameworksList: any;
export declare const CDXGEN_VERSION: any;
 ...
 */
export declare function mapConanPkgRefToPurlStringAndNameAndVersion(conanPkgRef: string): any[];
/**
