...
it("parse cs pkg data backfills templated and missing versions", () => {
  ...
  assert.deepStrictEqual(byName["Castle.Core"].version, "4.4.1");
  // Ranges are declared constraints, not templates - kept verbatim
  assert.deepStrictEqual(byName.NUnit.version, "[3.13.3,4.0)");
});
...
it("parsePnpmLock resolves path-style cjs aliases", async () => {
  ...
  assert.deepStrictEqual(refs, [
    "pkg:npm/testplane@8.20.5_48cca363293027fd6fa5a896c04e9e8c",
    "pkg:npm/@wdio/utils@7.26.0_typescript@6.0.2",
    "pkg:npm/@wdio/utils@8.39.0",
    "pkg:npm/string-width@4.2.3",
  ]);
  const dependsOn = parsedList.dependenciesList.find(
    (d) =>
      d.ref === "pkg:npm/testplane@8.20.5_48cca363293027fd6fa5a896c04e9e8c",
  ).dependsOn;
