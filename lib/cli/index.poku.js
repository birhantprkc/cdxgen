...
import { resolvePluginBinary } from "../helpers/plugins.js";
    ...
    it("requires explicit opt-in for AI inventory in js and python scans", async () => {
      ...
      try {
        ...
        const directHfDatasetPurl =
          "pkg:huggingface/rohitnagareddy/python-coding-instructions?repository_url=https%3A%2F%2Fhuggingface.co%2Fdatasets";
        const directHfDatasetResolvedBomRef =
          "pkg:huggingface/rohitnagareddy/python-coding-instructions@data123?repository_url=https%3A%2F%2Fhuggingface.co%2Fdatasets";
        ...
        const directHfSpacePurl =
          "pkg:huggingface/rohitnagareddy/qwen-coding-demo-space@space456?repository_url=https%3A%2F%2Fhuggingface.co%2Fspaces";
        const { cdxgenAgent } = await import("../helpers/utils.js");
